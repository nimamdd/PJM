...
from .views import ProjectListCreateViews, ProjectListUpdateDeleteView, \
    TaskProjectListCreate, SubtaskListCreate, TaskListUpdateDeleteViews, SubtaskListUpdateDeleteView
...
urlpatterns = [
    ...
    path('task/update/destroy/<int:pk>/', TaskListUpdateDeleteViews.as_view(), name='update_destroy_task'),
    path('subtask/<int:pk>/', SubtaskListCreate.as_view(), name='create_list_subtask_task_project'),
    path('subtask/update/destroy/<int:pk>/', SubtaskListUpdateDeleteView.as_view(), name='update_destroy_subtask')
]
